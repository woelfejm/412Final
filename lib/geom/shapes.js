...
var Shapes = {
    ...
    init: function(gl) {
        ...
        this.ground = new TriangleMesh(gl, generateQuadData(100.0, 100));
        this.track = new TriangleMesh(gl, generateQuadNormal(50,50))
        this.cylinder = new TriangleMesh(gl, generateCylinderData(0.5,1,10));
        this.disk = new TriangleMesh(gl, generateDiskData(1.0, 8));
        this.sphere = new TriangleMesh(gl, generateSphereData(100));
